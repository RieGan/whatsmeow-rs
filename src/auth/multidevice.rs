    ...
    fn create_test_registration(device_id: u32) -> DeviceRegistration {
        ...
        DeviceRegistration {
            ...
            keys: PairingKeysData {
                noise_public: vec![1; 32],
                noise_private: vec![2; 32],
                identity_public: vec![3; 32],
                identity_private: vec![4; 32],
                static_public: vec![5; 32],
                static_private: vec![6; 32],
                registration_id: 12345,
            },
            pre_key_bundle: PreKeyBundleData {
                identity_key: vec![7; 32],
                signed_prekey_id: 1,
                signed_prekey_public: vec![8; 32],
                signed_prekey_signature: vec![9; 64],
                prekey_id: Some(2),
                prekey_public: Some(vec![10; 32]),
                registration_id: 12345,
                device_id,
            },
